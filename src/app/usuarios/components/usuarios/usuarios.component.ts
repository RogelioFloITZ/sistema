...
export class UsuariosComponent implements OnInit {
  ...
  // public usuarios = [];
  constructor(private usuariosService: UsuariosService, private router: Router, public modal: NgbModal, public modalDelete: NgbModal, private formBuilder: FormBuilder, public formBuilderUpdate: FormBuilder, public modalUpdate: NgbModal) { }
  ...
  updateSubmit() {
    ...
    this.usuariosService.updateUser(this.updateForm.value._id, usuario).subscribe(res => {
      console.log(res);
      if (res.hasOwnProperty('message')) {
        let error: any = res;
